...
% Last modified: 30-Sep-2018
    ...
    methods (Static)
        ...
        function [trD, trLb, valD, valLb, trRegs, valRegs, trNegI, valNegI] = getPosAndRandomNeg()
            ...
            %end
            [trD, trLb, trRegs, trNegI]  = HW4_Utils.getPosAndRandomNegHelper('train');
            [valD, valLb, valRegs, valNegI] = HW4_Utils.getPosAndRandomNegHelper('val');
        ...
        function [D, lb, imRegs, negI] = getPosAndRandomNegHelper(dataset)
